...
urlpatterns = [
    ...
    url(r'^altergood/$', views.altergood, name='altergood'),
    url(r'^delgood/$', views.delgood, name='delgood'),
    url(r'^addband/$', views.addband, name='addband'),
    url(r'^alterband/$', views.alterband, name='alterband'),
    url(r'^delband/$', views.delband, name='delband'),
    ...
    url(r'^delbigcategory/$', views.delbigcategory, name='delbigcategory'),
    url(r'^addsmallcategory/$', views.addsmallcategory, name='addsmallcategory'),
    url(r'^altersmallcategory/$', views.altersmallcategory, name='altersmallcategory'),
    url(r'^delsmallcategory/$', views.delsmallcategory, name='delsmallcategory'),
    url(r'^addattrbute/$', views.addattrbute, name='addattrbute'),
    url(r'^alterattrbute/$', views.alterattrbute, name='alterattrbute'),
    url(r'^delattrbute/$', views.delattrbute, name='delattrbute'),
