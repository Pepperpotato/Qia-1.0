...
class UserUserCollections(models.Model):
...
class CommodityCategoriesTwoFour(models.Model):
...
class GoodsOne(models.Model):
    ...
    discount = models.CharField(unique=True, max_length=50)
...
class UserAccount(models.Model):
    ...
    useroffer_id = models.IntegerField(blank=True, null=True)
    goodoffer_id = models.IntegerField(blank=True, null=True)
